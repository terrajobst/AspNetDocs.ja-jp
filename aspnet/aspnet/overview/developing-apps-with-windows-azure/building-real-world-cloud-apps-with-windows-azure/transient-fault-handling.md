...
- [大規模なビルド。Azure のお客様 - パート II から学んだ教訓](https://channel9.msdn.com/Events/Build/2012/3-030)します。 一時的な障害の設計について、Mark Simms 説明は、処理、およびすべてのインストルメント化エラーします。
