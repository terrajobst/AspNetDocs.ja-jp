...
ASP.NET 2.0 を使用して、"To Do List"管理アプリケーションをゼロから作成するがいかに簡単かを参照してくださいし、ASP.NET AJAX Extensions を使用してユーザー エクスペリエンスを向上します。

[&#9654;ビデオ (20 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-ajax-a-demonstration-of-aspnet-ajax)
