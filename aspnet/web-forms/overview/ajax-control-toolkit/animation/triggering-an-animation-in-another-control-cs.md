...
[![A パネルのアニメーションを開始するマウス ボタンをクリックします](triggering-an-animation-in-another-control-cs/_static/image2.png)](triggering-an-animation-in-another-control-cs/_static/image1.png)
