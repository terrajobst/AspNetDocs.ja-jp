...
[![Tデータ ソースのエントリごとに、彼のモーダル ポップアップをトリガーできる](using-modalpopup-with-a-repeater-control-cs/_static/image2.png)](using-modalpopup-with-a-repeater-control-cs/_static/image1.png)
