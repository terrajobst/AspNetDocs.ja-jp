...
[![Figure 2:Default.aspx に SectionLevelTutorialListing.ascx ユーザー コントロールを追加する](caching-data-with-the-objectdatasource-cs/_static/image3.png)](caching-data-with-the-objectdatasource-cs/_static/image2.png)
...
[![C構成、ObjectDataSource ProductsBLL クラスを使用する](caching-data-with-the-objectdatasource-cs/_static/image7.png)](caching-data-with-the-objectdatasource-cs/_static/image6.png)
...
[![Set UpdateProduct の適切なオーバー ロードに更新] タブのドロップダウン リスト](caching-data-with-the-objectdatasource-cs/_static/image10.png)](caching-data-with-the-objectdatasource-cs/_static/image9.png)
...
[![EGridView サポート編集、並べ替え、およびページングを有効にする](caching-data-with-the-objectdatasource-cs/_static/image13.png)](caching-data-with-the-objectdatasource-cs/_static/image12.png)
...
[![Each 製品名、カテゴリ、および価格は、ソート可能、Pageable、編集可能な GridView に表示されます](caching-data-with-the-objectdatasource-cs/_static/image16.png)](caching-data-with-the-objectdatasource-cs/_static/image15.png)
...
[![Add ラベルと、ページ上 GridView にボタン](caching-data-with-the-objectdatasource-cs/_static/image19.png)](caching-data-with-the-objectdatasource-cs/_static/image18.png)
...
[![WGridView が発生したイベントを選択すると、データ ソースにバインドし henever が表示されます](caching-data-with-the-objectdatasource-cs/_static/image22.png)](caching-data-with-the-objectdatasource-cs/_static/image21.png)
...
[![Cポストバックのボタンと、そのビューステートから再構築する GridView になる](caching-data-with-the-objectdatasource-cs/_static/image25.png)](caching-data-with-the-objectdatasource-cs/_static/image24.png)
...
[![C構成を 30 秒間のデータをキャッシュする ObjectDataSource](caching-data-with-the-objectdatasource-cs/_static/image28.png)](caching-data-with-the-objectdatasource-cs/_static/image27.png)
