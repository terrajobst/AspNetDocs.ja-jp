...
[![Attach、NORTHWND します。App_Data フォルダーから MDF データベース](using-sql-cache-dependencies-cs/_static/image2.gif)](using-sql-cache-dependencies-cs/_static/image1.png)
...
[![C新しい ObjectDataSource という ProductsDataSourceDeclarative を reate](using-sql-cache-dependencies-cs/_static/image5.gif)](using-sql-cache-dependencies-cs/_static/image3.png)
...
[![U次の 3 つの入力パラメーターを持つオーバー ロード UpdateProduct se](using-sql-cache-dependencies-cs/_static/image6.gif)](using-sql-cache-dependencies-cs/_static/image5.png)

**図 6**:UpdateProduct のオーバー ロードを使用して、3 つの入力パラメーター ([フルサイズの画像を表示する をクリックします](using-sql-cache-dependencies-cs/_static/image6.png))。


[![Set (なし) を挿入および削除のタブのドロップダウン リスト](using-sql-cache-dependencies-cs/_static/image7.gif)](using-sql-cache-dependencies-cs/_static/image7.png)
...
[![T彼は ObjectDataSource のするイベントは、各時間、編集、GridView はページングまたは並べ替えが発生](using-sql-cache-dependencies-cs/_static/image8.gif)](using-sql-cache-dependencies-cs/_static/image9.png)
...
[![C構成のサポートのキャッシュを使用して SQL キャッシュ依存関係の製品およびカテゴリを ObjectDataSource](using-sql-cache-dependencies-cs/_static/image9.gif)](using-sql-cache-dependencies-cs/_static/image11.png)
...
[![Modifying の製品テーブルの削除にキャッシュされている製品のデータ](using-sql-cache-dependencies-cs/_static/image10.gif)](using-sql-cache-dependencies-cs/_static/image13.png)
...
[![C構成、ObjectDataSource ProductsCL クラスを使用する](using-sql-cache-dependencies-cs/_static/image11.gif)](using-sql-cache-dependencies-cs/_static/image15.png)

**図 11**:構成に使用する ObjectDataSource、`ProductsCL`クラス ([フルサイズの画像を表示する をクリックします](using-sql-cache-dependencies-cs/_static/image16.png))。


[![Sタブを選択してドロップダウン リストから GetProducts メソッドを選択](using-sql-cache-dependencies-cs/_static/image12.gif)](using-sql-cache-dependencies-cs/_static/image17.png)

**図 12**:選択、 `GetProducts`  タブを選択してドロップダウン リストからメソッド ([フルサイズの画像を表示する をクリックします](using-sql-cache-dependencies-cs/_static/image18.png))。


[![C選択更新] タブのドロップダウン リストから UpdateProduct メソッド](using-sql-cache-dependencies-cs/_static/image13.gif)](using-sql-cache-dependencies-cs/_static/image19.png)
