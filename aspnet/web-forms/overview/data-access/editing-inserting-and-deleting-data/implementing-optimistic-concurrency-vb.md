...
[![When の 2 つのユーザーは、1 人のユーザーへの変更の上書きのレコードが s 可能性を同時に更新](implementing-optimistic-concurrency-vb/_static/image2.png)](implementing-optimistic-concurrency-vb/_static/image1.png)
...
[![Fまたはを正常に更新または削除、元の値が現在のデータベースの値と等しくする必要があります](implementing-optimistic-concurrency-vb/_static/image5.png)](implementing-optimistic-concurrency-vb/_static/image4.png)
...
[![C同じ Northwind データベースに onnect](implementing-optimistic-concurrency-vb/_static/image8.png)](implementing-optimistic-concurrency-vb/_static/image7.png)
...
[![Sアドホック SQL ステートメントを使用して取得するデータを指定](implementing-optimistic-concurrency-vb/_static/image11.png)](implementing-optimistic-concurrency-vb/_static/image10.png)
...
[![Use 元の DAL の製品 TableAdapter から同じ SQL クエリ](implementing-optimistic-concurrency-vb/_static/image14.png)](implementing-optimistic-concurrency-vb/_static/image13.png)
...
[![E有効にするチェックによってオプティミスティック同時実行制御、&quot;オプティミスティック同時実行制御を使用して、&quot;チェック ボックス](implementing-optimistic-concurrency-vb/_static/image17.png)](implementing-optimistic-concurrency-vb/_static/image16.png)
...
[![HTableAdapter 利用すべてのデータ アクセス パターン [ave](implementing-optimistic-concurrency-vb/_static/image20.png)](implementing-optimistic-concurrency-vb/_static/image19.png)
...
[![A 型指定された DataSet に DataTable と TableAdapter が追加されました](implementing-optimistic-concurrency-vb/_static/image23.png)](implementing-optimistic-concurrency-vb/_static/image22.png)
...
[![Mクエリを入力として裏庭、&quot;を行を返す SELECT&quot;](implementing-optimistic-concurrency-vb/_static/image26.png)](implementing-optimistic-concurrency-vb/_static/image25.png)
...
[![Add を特定の製品レコードを返す Pre-Loaded クエリに WHERE 句](implementing-optimistic-concurrency-vb/_static/image29.png)](implementing-optimistic-concurrency-vb/_static/image28.png)
...
[![Rename FillByProductID を GetProductByProductID メソッド](implementing-optimistic-concurrency-vb/_static/image32.png)](implementing-optimistic-concurrency-vb/_static/image31.png)
...
[![Have ProductsOptimisticConcurrencyBLL オブジェクトを使用して ObjectDataSource](implementing-optimistic-concurrency-vb/_static/image36.png)](implementing-optimistic-concurrency-vb/_static/image35.png)
...
[![TGridView では、彼の製品が一覧表示](implementing-optimistic-concurrency-vb/_static/image39.png)](implementing-optimistic-concurrency-vb/_static/image38.png)
...
[![Attempting Any 製品の結果に、FormatException を削除する](implementing-optimistic-concurrency-vb/_static/image42.png)](implementing-optimistic-concurrency-vb/_static/image41.png)
...
[![TObjectDataSource 彼には、送信する入力パラメーターを持つメソッドが見つかりません](implementing-optimistic-concurrency-vb/_static/image45.png)](implementing-optimistic-concurrency-vb/_static/image44.png)
...
[![W同時実行制御違反が検出されると、hen、DBConcurrencyException がスローされます](implementing-optimistic-concurrency-vb/_static/image48.png)](implementing-optimistic-concurrency-vb/_static/image47.png)
...
[![Two ラベル コントロールがページに追加されました](implementing-optimistic-concurrency-vb/_static/image51.png)](implementing-optimistic-concurrency-vb/_static/image50.png)
...
[![A ユーザーの更新プログラムは、同時実行制御違反の表面に失われます](implementing-optimistic-concurrency-vb/_static/image54.png)](implementing-optimistic-concurrency-vb/_static/image53.png)
...
[![A 同時実行制御違反が発生した場合は、ユーザーの削除がキャンセル](implementing-optimistic-concurrency-vb/_static/image57.png)](implementing-optimistic-concurrency-vb/_static/image56.png)
