...
## <a name="step-1-replicating-the-example-fromexamining-the-events-associated-with-inserting-updating-and-deleting"></a>手順 1:[挿入、更新、および削除に関連付けられたイベントを調べる](examining-the-events-associated-with-inserting-updating-and-deleting-cs.md)例をレプリケートする
