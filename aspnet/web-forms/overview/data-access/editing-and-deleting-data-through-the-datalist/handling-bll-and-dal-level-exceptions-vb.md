...
[![Return GetProducts() メソッドを使用して、製品情報](handling-bll-and-dal-level-exceptions-vb/_static/image2.png)](handling-bll-and-dal-level-exceptions-vb/_static/image1.png)
...
[![Each 製品には、[編集] ボタンが含まれています](handling-bll-and-dal-level-exceptions-vb/_static/image5.png)](handling-bll-and-dal-level-exceptions-vb/_static/image4.png)
...
[![Aユーザーが必要なフィールドを付ける場合は、n のエラー メッセージが表示されます](handling-bll-and-dal-level-exceptions-vb/_static/image9.png)](handling-bll-and-dal-level-exceptions-vb/_static/image8.png)
...
[![An のエラー メッセージは、表示されるときに入力を負の価格は](handling-bll-and-dal-level-exceptions-vb/_static/image12.png)](handling-bll-and-dal-level-exceptions-vb/_static/image11.png)
