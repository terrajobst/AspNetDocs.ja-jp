...
> ObjectDataSource コントロールを使用して n 層アプリケーションとして Contoso U アプリケーションを構築する方法と、同時実行を処理してパフォーマンスを最大化する方法について説明します。

- [Entity Framework 4.0 と ObjectDataSource コントロール、パート 1: 概要](using-the-entity-framework-and-the-objectdatasource-control-part-1-getting-started.md)
