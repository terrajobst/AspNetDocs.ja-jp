...
- [Entity Framework 4.0 と ObjectDataSource コントロール、第 1 部:作業の開始](using-the-entity-framework-and-the-objectdatasource-control-part-1-getting-started.md)
- [Entity Framework 4.0 と ObjectDataSource コントロール、第 2 部:ビジネス ロジック層と単体テストの追加](using-the-entity-framework-and-the-objectdatasource-control-part-2-adding-a-business-logic-layer-and-unit-tests.md)
- [Entity Framework 4.0 と ObjectDataSource コントロール、第 3 部:並べ替えとフィルター処理](using-the-entity-framework-and-the-objectdatasource-control-part-3-sorting-and-filtering.md)
