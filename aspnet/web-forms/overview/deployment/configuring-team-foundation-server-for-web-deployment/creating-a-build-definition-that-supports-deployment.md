...
<span data-ttu-id="ebfb0-123">ビルドをトリガーするときに、これらの操作を行う必要があります。</span><span class="sxs-lookup"><span data-stu-id="ebfb0-123">When you trigger a build, these actions need to happen:</span></span>
