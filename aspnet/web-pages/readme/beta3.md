...
#### <a name="issue-webmatrix-beta-3-is-only-available-on-platforms-that-support-microsoft-net-framework-4"></a>問題:WebMatrix の Beta 3 は、Microsoft .NET Framework 4 をサポートするプラットフォームで利用可能なのみ
...
#### <a name="new-htmlraw-method-renders-unencoded-markup"></a>新規 : "Html.Raw"メソッドは、エンコードされていないマークアップを出力します。
...
#### <a name="issue-encrypt-property-is-not-recognized"></a>問題:「暗号化」のプロパティを認識できません。
...
#### <a name="issue-searchfilter-does-not-work-in-reports-for-group-by-issue-type"></a>問題:検索とフィルターのレポートでグループ化できません。問題の種類
