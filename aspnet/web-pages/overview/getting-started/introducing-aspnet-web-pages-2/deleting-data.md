...
## <a name="adding-code-to-read-a-single-movie"></a><span data-ttu-id="a2e2d-163">1 つのムービーを読み取るコードを追加します。</span><span class="sxs-lookup"><span data-stu-id="a2e2d-163">Adding Code to Read a Single Movie</span></span>
