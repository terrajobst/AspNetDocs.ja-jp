...
ms.locfileid: "78454174"
---
# <a name="aspnet-web-forms-and-ajax-451"></a><span data-ttu-id="8e89e-102">ASP.NET Web フォームと Ajax 4.5.1</span><span class="sxs-lookup"><span data-stu-id="8e89e-102">ASP.NET Web Forms and Ajax 4.5.1</span></span>

<span data-ttu-id="8e89e-103">CDN でホストされているファイルは次のとおりです。</span><span class="sxs-lookup"><span data-stu-id="8e89e-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="8e89e-104">注: fr-FR.js など、グローバリゼーション スクリプトは、次のフォルダーに格納されています。</span><span class="sxs-lookup"><span data-stu-id="8e89e-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
