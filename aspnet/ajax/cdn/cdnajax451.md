...
ms.locfileid: "59414544"
---
# <a name="aspnet-web-forms-and-ajax-451"></a><span data-ttu-id="bfbb8-102">ASP.NET Web フォームと Ajax 4.5.1</span><span class="sxs-lookup"><span data-stu-id="bfbb8-102">ASP.NET Web Forms and Ajax 4.5.1</span></span>

<span data-ttu-id="bfbb8-103">次のファイルは、CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="bfbb8-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="bfbb8-104">メモ:Fr-FR.js など、グローバリゼーション スクリプトは、次のフォルダーにあります。</span><span class="sxs-lookup"><span data-stu-id="bfbb8-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
