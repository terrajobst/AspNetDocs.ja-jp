...
ms.locfileid: "57053469"
---
<a name="jquery-validate-16"></a><span data-ttu-id="9e0db-102">jQuery Validate 1.6</span><span class="sxs-lookup"><span data-stu-id="9e0db-102">jQuery Validate 1.6</span></span>
====================
<span data-ttu-id="9e0db-103">次のファイルは、CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="9e0db-103">The following files are hosted on the CDN:</span></span>
