...
ms.locfileid: "59379077"
---
# <a name="jquery-validation-1140"></a><span data-ttu-id="b6aa9-102">jQuery Validation 1.14.0</span><span class="sxs-lookup"><span data-stu-id="b6aa9-102">jQuery Validation 1.14.0</span></span>

<span data-ttu-id="b6aa9-103">次のファイルは、CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="b6aa9-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="b6aa9-104">あるファイルをローカライズ https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages\_##.js 場所 ## loc コードに示します。</span><span class="sxs-lookup"><span data-stu-id="b6aa9-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages\_##.js where ## is the loc code.</span></span>
