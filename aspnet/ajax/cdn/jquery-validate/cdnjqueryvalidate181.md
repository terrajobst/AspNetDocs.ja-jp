...
---
<a name="jqueryvalidate-version-181"></a>jquery.validate バージョン 1.8.1
====================
...
- あるファイルをローカライズ https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js場所 ## loc コードに示します。
