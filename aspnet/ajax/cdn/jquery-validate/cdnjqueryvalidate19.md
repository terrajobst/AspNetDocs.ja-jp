...
ms.locfileid: "59387075"
---
# <a name="jqueryvalidate-version-19"></a><span data-ttu-id="24ab6-102">jquery.validate バージョン 1.9</span><span class="sxs-lookup"><span data-stu-id="24ab6-102">jquery.validate version 1.9</span></span>

<span data-ttu-id="24ab6-103">次のファイルは、CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="24ab6-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="24ab6-104">あるファイルをローカライズ https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js場所 ## loc コードに示します。</span><span class="sxs-lookup"><span data-stu-id="24ab6-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js where ## is the loc code.</span></span>
