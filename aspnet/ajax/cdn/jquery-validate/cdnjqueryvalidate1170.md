...
ms.locfileid: "59389701"
---
# <a name="jquery-validation-1170"></a><span data-ttu-id="41819-102">jQuery Validation 1.17.0 以降</span><span class="sxs-lookup"><span data-stu-id="41819-102">jQuery Validation 1.17.0</span></span>

<span data-ttu-id="41819-103">次のファイルは、CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="41819-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="41819-104">あるファイルをローカライズ https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js 場所 ## loc コードに示します。</span><span class="sxs-lookup"><span data-stu-id="41819-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js where ## is the loc code.</span></span>
