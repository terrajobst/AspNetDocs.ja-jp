...
ms.locfileid: "59415935"
---
# <a name="jquery-datatables-1105"></a><span data-ttu-id="df625-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="df625-102">jQuery DataTables 1.10.5</span></span>

<span data-ttu-id="df625-103">CDN では、jQuery プラグインの Datatable には、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="df625-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
