...
ms.locfileid: "78454132"
---
# <a name="jquery-datatables-1105"></a><span data-ttu-id="e6eed-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="e6eed-102">jQuery DataTables 1.10.5</span></span>

<span data-ttu-id="e6eed-103">JQuery Datatable プラグインの次のファイルは、CDN でホストされます。</span><span class="sxs-lookup"><span data-stu-id="e6eed-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
