...
ms.locfileid: "78454150"
---
# <a name="jquery-datatables-1104"></a><span data-ttu-id="da1e2-102">jQuery DataTables 1.10.4</span><span class="sxs-lookup"><span data-stu-id="da1e2-102">jQuery DataTables 1.10.4</span></span>

<span data-ttu-id="da1e2-103">JQuery Datatable プラグインの次のファイルは、CDN でホストされます。</span><span class="sxs-lookup"><span data-stu-id="da1e2-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
