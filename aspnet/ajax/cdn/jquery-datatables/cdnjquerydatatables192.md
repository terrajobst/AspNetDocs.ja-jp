...
ms.locfileid: "57027799"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="ba7d0-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="ba7d0-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="ba7d0-103">CDN では、jQuery プラグインの Datatable には、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="ba7d0-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
