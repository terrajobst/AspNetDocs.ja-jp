...
ms.locfileid: "59387634"
---
# <a name="jquery-datatables-192"></a><span data-ttu-id="96744-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="96744-102">jQuery DataTables 1.9.2</span></span>

<span data-ttu-id="96744-103">CDN では、jQuery プラグインの Datatable には、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="96744-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
