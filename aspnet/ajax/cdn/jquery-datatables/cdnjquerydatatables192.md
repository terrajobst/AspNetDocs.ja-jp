...
ms.locfileid: "78454018"
---
# <a name="jquery-datatables-192"></a><span data-ttu-id="8dfe9-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="8dfe9-102">jQuery DataTables 1.9.2</span></span>

<span data-ttu-id="8dfe9-103">JQuery Datatable プラグインの次のファイルは、CDN でホストされます。</span><span class="sxs-lookup"><span data-stu-id="8dfe9-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
