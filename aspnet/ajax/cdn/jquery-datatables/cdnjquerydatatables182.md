...
ms.locfileid: "59411905"
---
# <a name="jquery-datatables-182"></a><span data-ttu-id="1337b-102">jQuery DataTables 1.8.2</span><span class="sxs-lookup"><span data-stu-id="1337b-102">jQuery DataTables 1.8.2</span></span>

<span data-ttu-id="1337b-103">CDN では、jQuery プラグインの Datatable には、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="1337b-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
