...
ms.locfileid: "78454024"
---
# <a name="jquery-datatables-193"></a><span data-ttu-id="b9af8-102">jQuery DataTables 1.9.3</span><span class="sxs-lookup"><span data-stu-id="b9af8-102">jQuery DataTables 1.9.3</span></span>

<span data-ttu-id="b9af8-103">JQuery Datatable プラグインの次のファイルは、CDN でホストされます。</span><span class="sxs-lookup"><span data-stu-id="b9af8-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
