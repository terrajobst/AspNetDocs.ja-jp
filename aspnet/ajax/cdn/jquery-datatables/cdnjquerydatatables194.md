...
ms.locfileid: "59383370"
---
# <a name="jquery-datatables-194"></a><span data-ttu-id="0b71f-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="0b71f-102">jQuery DataTables 1.9.4</span></span>

<span data-ttu-id="0b71f-103">CDN では、jQuery プラグインの Datatable には、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="0b71f-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
