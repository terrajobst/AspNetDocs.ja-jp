...
ms.locfileid: "78454048"
---
# <a name="jquery-datatables-194"></a><span data-ttu-id="82f8c-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="82f8c-102">jQuery DataTables 1.9.4</span></span>

<span data-ttu-id="82f8c-103">JQuery Datatable プラグインの次のファイルは、CDN でホストされます。</span><span class="sxs-lookup"><span data-stu-id="82f8c-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
