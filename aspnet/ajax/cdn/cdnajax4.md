...
title: ASP.NET Web フォームと Ajax 4 |Microsoft Docs
...
ms.locfileid: "78454168"
---
# <a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="a1637-102">ASP.NET Web Forms および Ajax 4</span><span class="sxs-lookup"><span data-stu-id="a1637-102">ASP.NET Web Forms and Ajax 4</span></span>

<span data-ttu-id="a1637-103">CDN でホストされているファイルは次のとおりです。</span><span class="sxs-lookup"><span data-stu-id="a1637-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="a1637-104">注: fr-FR.js など、グローバリゼーション スクリプトは、次のフォルダーに格納されています。</span><span class="sxs-lookup"><span data-stu-id="a1637-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
