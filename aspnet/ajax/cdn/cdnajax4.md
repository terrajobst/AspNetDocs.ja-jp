...
title: ASP.NET Web Forms および Ajax 4 |Microsoft Docs
...
ms.locfileid: "59419952"
---
# <a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="16618-102">ASP.NET Web フォームと Ajax 4</span><span class="sxs-lookup"><span data-stu-id="16618-102">ASP.NET Web Forms and Ajax 4</span></span>

<span data-ttu-id="16618-103">次のファイルは、CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="16618-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="16618-104">メモ:Fr-FR.js など、グローバリゼーション スクリプトは、次のフォルダーにあります。</span><span class="sxs-lookup"><span data-stu-id="16618-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
