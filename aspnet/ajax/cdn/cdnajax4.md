...
ms.locfileid: "57045469"
---
<a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="1fa26-102">ASP.NET Web フォームと Ajax 4</span><span class="sxs-lookup"><span data-stu-id="1fa26-102">ASP.NET Web Forms and Ajax 4</span></span>
====================
<span data-ttu-id="1fa26-103">次のファイルは、CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="1fa26-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="1fa26-104">メモ:Fr-FR.js など、グローバリゼーション スクリプトは、次のフォルダーにあります。</span><span class="sxs-lookup"><span data-stu-id="1fa26-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
