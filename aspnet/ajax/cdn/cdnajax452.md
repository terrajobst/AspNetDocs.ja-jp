...
ms.locfileid: "57030739"
---
<a name="aspnet-web-forms-and-ajax-452"></a><span data-ttu-id="a6b50-102">ASP.NET Web フォームと Ajax 4.5.2</span><span class="sxs-lookup"><span data-stu-id="a6b50-102">ASP.NET Web Forms and Ajax 4.5.2</span></span>
====================
<span data-ttu-id="a6b50-103">次のファイルは、CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="a6b50-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="a6b50-104">メモ:Fr-FR.js など、グローバリゼーション スクリプトは、次のフォルダーにあります。</span><span class="sxs-lookup"><span data-stu-id="a6b50-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
