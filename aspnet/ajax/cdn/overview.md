...
>
> 使用[この GitHub の問題](https://github.com/aspnet/AspNetDocs/issues/116)Microsoft Ajax CDN の問題を報告します。
...
#### <a name="jquery-version-341"></a>jQuery バージョン 3.4.1
...
#### <a name="jquery-version-340"></a>jQuery バージョン 3.4.0
...
#### <a name="bootstrap-version-431"></a>ブートス トラップ バージョン 4.3.1
...
#### <a name="bootstrap-version-421"></a>ブートス トラップ バージョン 4.2.1
...
#### <a name="bootstrap-version-341"></a>ブートス トラップ バージョン 3.4.1
...
#### <a name="bootstrap-version-340"></a>ブートス トラップ バージョン 3.4.0
