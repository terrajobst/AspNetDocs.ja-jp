...
<span data-ttu-id="c8a1a-113">**[Cdn のサード パーティ製ファイル](#Third-Party_Files_on_the_CDN_23)**</span><span class="sxs-lookup"><span data-stu-id="c8a1a-113">**[Third-Party Files on the CDN](#Third-Party_Files_on_the_CDN_23)**</span></span>  
 ...
 [<span data-ttu-id="c8a1a-114">cdn の jQuery リリース</span><span class="sxs-lookup"><span data-stu-id="c8a1a-114">jQuery Releases on the CDN</span></span>](#jQuery_Releases_on_the_CDN_0)  
...
<span data-ttu-id="c8a1a-135">CDN を利用して、Ajax アプリケーションのパフォーマンスを大幅に向上させることができます。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-135">By taking advantage of the CDN, you can significantly improve the performance of your Ajax applications.</span></span> <span data-ttu-id="c8a1a-136">CDN のコンテンツは、世界各地に配置されたサーバーにキャッシュされます。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-136">The contents of the CDN are cached on servers located around the world.</span></span> <span data-ttu-id="c8a1a-137">さらに、CDN は、別のドメインに配置されている web サイトのキャッシュされたサード パーティ製の JavaScript ファイルを再利用のブラウザーを使用できます。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-137">In addition, the CDN enables browsers to reuse cached third party JavaScript files for web sites that are located in different domains.</span></span>
...
<span data-ttu-id="c8a1a-167">Visual Studio 2010 では、追加、更新プログラムなし .vsdoc ファイルをサポートします。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-167">Visual Studio 2010 supports .vsdoc files without any additional patches.</span></span>
...
<span data-ttu-id="c8a1a-192">詳細については、jQuery UI ライブラリ、公式を参照してください。 [jQuery UI の web サイト](http://jQueryUI.com "jQuery UI の web サイト")します。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-192">To learn more about the jQuery UI library, visit the official [jQuery UI website](http://jQueryUI.com "jQuery UI website").</span></span>
...
#### <a name="jquery-version-320"></a><span data-ttu-id="c8a1a-203">jQuery バージョン 3.2.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-203">jQuery version 3.2.0</span></span>
...
#### <a name="jquery-version-162"></a><span data-ttu-id="c8a1a-244">jQuery バージョン 1.6.2</span><span class="sxs-lookup"><span data-stu-id="c8a1a-244">jQuery version 1.6.2</span></span>
...
<span data-ttu-id="c8a1a-257">CDN では、jQuery の移行の次のリリースがホストされています。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-257">The following releases of jQuery Migrate are hosted on the CDN:</span></span>
...
- [<span data-ttu-id="c8a1a-286">jQuery UI 1.8.20</span><span class="sxs-lookup"><span data-stu-id="c8a1a-286">jQuery UI 1.8.20</span></span>](jquery-ui/cdnjqueryui1820.md "jQuery UI 1.8.20 Microsoft Ajax CDN")
...
- [<span data-ttu-id="c8a1a-361">jQuery 1.9.1 Datatable</span><span class="sxs-lookup"><span data-stu-id="c8a1a-361">jQuery DataTables 1.9.1</span></span>](jquery-datatables/cdnjquerydatatables191.md "jQuery 1.9.1 Datatable")
...
### <a name="globalize-releases-on-the-cdn"></a><span data-ttu-id="c8a1a-370">CDN でリリースをグローバル化します。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-370">Globalize Releases on the CDN</span></span>

<span data-ttu-id="c8a1a-371">次のリリースの[Globalize](https://github.com/jquery/globalize "Globalize") CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-371">The following releases of [Globalize](https://github.com/jquery/globalize "Globalize") are hosted on the CDN:</span></span>

#### <a name="globalize-version-100"></a><span data-ttu-id="c8a1a-372">バージョン 1.0.0 のグローバル化します。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-372">Globalize version 1.0.0</span></span>
...
#### <a name="globalize-version-011"></a><span data-ttu-id="c8a1a-373">バージョンは 0.1.1 をグローバル化します。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-373">Globalize version 0.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.min.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.cultures.js

    - <span data-ttu-id="c8a1a-374">すべてのカルチャ</span><span class="sxs-lookup"><span data-stu-id="c8a1a-374">all cultures</span></span>
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.culture.{culture-code}.js

    - <span data-ttu-id="c8a1a-375">「{カルチャ コード}」を目的のカルチャ コードに置き換えます、cdn の globalize.culture.en GB.js== Microsoft のファイルなど、これらを = = ライブラリは、Microsoft によってアップロードされました。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-375">Replace "{culture-code}" with the desired culture code, e.g. globalize.culture.en-GB.js== Microsoft Files on the CDN ==These libraries were uploaded by Microsoft.</span></span>

<a id="Respond_Releases_on_the_CDN_13"></a>

### <a name="respond-releases-on-the-cdn"></a><span data-ttu-id="c8a1a-376">Cdn のリリースを応答します。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-376">Respond Releases on the CDN</span></span>

<span data-ttu-id="c8a1a-377">次のリリースの [https://github.com/scottjehl/Respond](https://github.com/scottjehl/Respond "https://github.com/scottjehl/Respond") 応答が CDN にホストされています。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-377">The following releases of [https://github.com/scottjehl/Respond](https://github.com/scottjehl/Respond "https://github.com/scottjehl/Respond") Respond are hosted on the CDN:</span></span>

#### <a name="respond-version-142"></a><span data-ttu-id="c8a1a-378">応答バージョン 1.4.2</span><span class="sxs-lookup"><span data-stu-id="c8a1a-378">Respond version 1.4.2</span></span>
...
#### <a name="respond-version-141"></a><span data-ttu-id="c8a1a-379">応答バージョン 1.4.1</span><span class="sxs-lookup"><span data-stu-id="c8a1a-379">Respond version 1.4.1</span></span>
...
#### <a name="respond-version-140"></a><span data-ttu-id="c8a1a-380">応答バージョン 1.4.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-380">Respond version 1.4.0</span></span>
...
#### <a name="respond-version-130"></a><span data-ttu-id="c8a1a-381">応答バージョン 1.3.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-381">Respond version 1.3.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.3.0/respond.js

#### <a name="respond-version-120"></a><span data-ttu-id="c8a1a-382">応答バージョン 1.2.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-382">Respond version 1.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.2.0/respond.js

<a id="Bootstrap_Releases_on_the_CDN_14"></a>

### <a name="bootstrap-releases-on-the-cdn"></a><span data-ttu-id="c8a1a-383">Cdn のブートス トラップのリリース</span><span class="sxs-lookup"><span data-stu-id="c8a1a-383">Bootstrap Releases on the CDN</span></span>

<span data-ttu-id="c8a1a-384">次のリリースの[getbootstrap.com](http://getbootstrap.com "getbootstrap.com")ブートス トラップが CDN にホストされています。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-384">The following releases of [getbootstrap.com](http://getbootstrap.com "getbootstrap.com") bootstrap are hosted on the CDN:</span></span>

#### <a name="bootstrap-version-431"></a><span data-ttu-id="c8a1a-385">ブートス トラップ バージョン 4.3.1</span><span class="sxs-lookup"><span data-stu-id="c8a1a-385">Bootstrap version 4.3.1</span></span>
...
#### <a name="bootstrap-version-421"></a><span data-ttu-id="c8a1a-386">ブートス トラップ バージョン 4.2.1</span><span class="sxs-lookup"><span data-stu-id="c8a1a-386">Bootstrap version 4.2.1</span></span>
...
#### <a name="bootstrap-version-411"></a><span data-ttu-id="c8a1a-387">ブートス トラップのバージョン 4.1.1</span><span class="sxs-lookup"><span data-stu-id="c8a1a-387">Bootstrap version 4.1.1</span></span>
...
#### <a name="bootstrap-version-400"></a><span data-ttu-id="c8a1a-388">ブートス トラップ バージョン 4.0.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-388">Bootstrap version 4.0.0</span></span>
...
#### <a name="bootstrap-version-341"></a><span data-ttu-id="c8a1a-389">ブートス トラップ バージョン 3.4.1</span><span class="sxs-lookup"><span data-stu-id="c8a1a-389">Bootstrap version 3.4.1</span></span>
...
#### <a name="bootstrap-version-340"></a><span data-ttu-id="c8a1a-390">ブートス トラップ バージョン 3.4.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-390">Bootstrap version 3.4.0</span></span>
...
#### <a name="bootstrap-version-337"></a><span data-ttu-id="c8a1a-391">ブートス トラップ バージョン 3.3.7</span><span class="sxs-lookup"><span data-stu-id="c8a1a-391">Bootstrap version 3.3.7</span></span>
...
#### <a name="bootstrap-version-336"></a><span data-ttu-id="c8a1a-392">ブートス トラップ バージョン 3.3.6</span><span class="sxs-lookup"><span data-stu-id="c8a1a-392">Bootstrap version 3.3.6</span></span>
...
#### <a name="bootstrap-version-335"></a><span data-ttu-id="c8a1a-393">バージョン 3.3.5 をブートス トラップします。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-393">Bootstrap version 3.3.5</span></span>
...
#### <a name="bootstrap-version-334"></a><span data-ttu-id="c8a1a-394">ブートス トラップ バージョン 3.3.4</span><span class="sxs-lookup"><span data-stu-id="c8a1a-394">Bootstrap version 3.3.4</span></span>
...
#### <a name="bootstrap-version-332"></a><span data-ttu-id="c8a1a-395">ブートス トラップ バージョン 3.3.2</span><span class="sxs-lookup"><span data-stu-id="c8a1a-395">Bootstrap version 3.3.2</span></span>
...
#### <a name="bootstrap-version-331"></a><span data-ttu-id="c8a1a-396">ブートス トラップ バージョン 3.3.1</span><span class="sxs-lookup"><span data-stu-id="c8a1a-396">Bootstrap version 3.3.1</span></span>
...
#### <a name="bootstrap-version-330"></a><span data-ttu-id="c8a1a-397">ブートス トラップ バージョン 3.3.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-397">Bootstrap version 3.3.0</span></span>
...
#### <a name="bootstrap-version-320"></a><span data-ttu-id="c8a1a-398">ブートス トラップ バージョン 3.2.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-398">Bootstrap version 3.2.0</span></span>
...
#### <a name="bootstrap-version-311"></a><span data-ttu-id="c8a1a-399">3.1.1 ブートス トラップのバージョン</span><span class="sxs-lookup"><span data-stu-id="c8a1a-399">Bootstrap version 3.1.1</span></span>
...
#### <a name="bootstrap-version-310"></a><span data-ttu-id="c8a1a-400">バージョン 3.1.0 のブートス トラップします。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-400">Bootstrap version 3.1.0</span></span>
...
#### <a name="bootstrap-version-303"></a><span data-ttu-id="c8a1a-401">ブートス トラップ バージョン 3.0.3</span><span class="sxs-lookup"><span data-stu-id="c8a1a-401">Bootstrap version 3.0.3</span></span>
...
#### <a name="bootstrap-version-302"></a><span data-ttu-id="c8a1a-402">ブートス トラップ バージョン 3.0.2</span><span class="sxs-lookup"><span data-stu-id="c8a1a-402">Bootstrap version 3.0.2</span></span>
...
#### <a name="bootstrap-version-301"></a><span data-ttu-id="c8a1a-403">バージョン 3.0.1 をブートス トラップします。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-403">Bootstrap version 3.0.1</span></span>
...
#### <a name="bootstrap-version-300"></a><span data-ttu-id="c8a1a-404">バージョン 3.0.0 のブートス トラップします。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-404">Bootstrap version 3.0.0</span></span>
...
#### <a name="bootstrap-version-232"></a><span data-ttu-id="c8a1a-405">バージョン 2.3.2 のブートス トラップします。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-405">Bootstrap version 2.3.2</span></span>
...
#### <a name="bootstrap-version-231"></a><span data-ttu-id="c8a1a-406">Version 2.3.1 のブートス トラップします。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-406">Bootstrap version 2.3.1</span></span>
...
### <a name="bootstrap-touchcarousel-releases-on-the-cdn"></a><span data-ttu-id="c8a1a-407">Cdn のブートス トラップ TouchCarousel リリース</span><span class="sxs-lookup"><span data-stu-id="c8a1a-407">Bootstrap TouchCarousel Releases on the CDN</span></span>

<span data-ttu-id="c8a1a-408">次のリリースの[https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel")ブートス トラップ TouchCarousel リリースは、CDN でホストされています。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-408">The following releases of [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") Bootstrap TouchCarousel releases are hosted on the CDN:</span></span>

#### <a name="bootstrap-touchcarousel-version-080"></a><span data-ttu-id="c8a1a-409">ブートス トラップ TouchCarousel バージョン 0.8.0 以降</span><span class="sxs-lookup"><span data-stu-id="c8a1a-409">Bootstrap TouchCarousel version 0.8.0</span></span>
...
### <a name="hammerjs-releases-on-the-cdn"></a><span data-ttu-id="c8a1a-410">Cdn Hammer.js リリース</span><span class="sxs-lookup"><span data-stu-id="c8a1a-410">Hammer.js Releases on the CDN</span></span>

<span data-ttu-id="c8a1a-411">次のリリースの[http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js リリースは、CDN でホストされています。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-411">The following releases of [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js releases are hosted on the CDN:</span></span>

#### <a name="hammerjs-version-204"></a><span data-ttu-id="c8a1a-412">Hammer.js バージョン 2.0.4</span><span class="sxs-lookup"><span data-stu-id="c8a1a-412">Hammer.js version 2.0.4</span></span>
...
### <a name="aspnet-web-forms-and-ajax-releases-on-the-cdn"></a><span data-ttu-id="c8a1a-413">ASP.NET Web フォームと Ajax CDN のリリース</span><span class="sxs-lookup"><span data-stu-id="c8a1a-413">ASP.NET Web Forms and Ajax Releases on the CDN</span></span>

<span data-ttu-id="c8a1a-414">ASP.NET Ajax ライブラリの次のリリースは、CDN でホストされます。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-414">The following releases of the ASP.NET Ajax Library are hosted on the CDN.</span></span> <span data-ttu-id="c8a1a-415">ファイルの実際の一覧を表示するには、各リンクをクリックします。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-415">Click each link to see the actual list of files.</span></span>

- [<span data-ttu-id="c8a1a-416">ASP.NET Web フォームと Ajax バージョン 4.5.2</span><span class="sxs-lookup"><span data-stu-id="c8a1a-416">ASP.NET Web Forms and Ajax version 4.5.2</span></span>](cdnajax452.md "ASP.NET Web フォームと Ajax 4.5.2")
- [<span data-ttu-id="c8a1a-417">ASP.NET Web フォームと Ajax バージョン 4</span><span class="sxs-lookup"><span data-stu-id="c8a1a-417">ASP.NET Web Forms and Ajax version 4</span></span>](cdnajax4.md "ASP.NET Web フォームと Ajax 4")
- [<span data-ttu-id="c8a1a-418">ASP.NET Ajax 3.5</span><span class="sxs-lookup"><span data-stu-id="c8a1a-418">ASP.NET Ajax version 3.5</span></span>](cdnajax35.md "ASP.NET Ajax 3.5")

<a id="ASPNET_MVC_Releases_on_the_CDN_16"></a>

### <a name="aspnet-mvc-releases-on-the-cdn"></a><span data-ttu-id="c8a1a-419">ASP.NET MVC は、CDN にリリースします。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-419">ASP.NET MVC Releases on the CDN</span></span>

<span data-ttu-id="c8a1a-420">次の ASP.NET MVC の JavaScript ファイルは、この CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-420">The following ASP.NET MVC JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-mvc-523"></a><span data-ttu-id="c8a1a-421">ASP.NET MVC 5.2.3</span><span class="sxs-lookup"><span data-stu-id="c8a1a-421">ASP.NET MVC 5.2.3</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-51"></a><span data-ttu-id="c8a1a-422">ASP.NET MVC 5.1</span><span class="sxs-lookup"><span data-stu-id="c8a1a-422">ASP.NET MVC 5.1</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-50"></a><span data-ttu-id="c8a1a-423">ASP.NET MVC 5.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-423">ASP.NET MVC 5.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-40"></a><span data-ttu-id="c8a1a-424">ASP.NET MVC 4.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-424">ASP.NET MVC 4.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-30"></a><span data-ttu-id="c8a1a-425">ASP.NET MVC 3.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-425">ASP.NET MVC 3.0</span></span>
...
#### <a name="aspnet-mvc-20"></a><span data-ttu-id="c8a1a-426">ASP.NET MVC 2.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-426">ASP.NET MVC 2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.js
- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.debug.js

#### <a name="aspnet-mvc-10"></a><span data-ttu-id="c8a1a-427">ASP.NET MVC 1.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-427">ASP.NET MVC 1.0</span></span>
...
### <a name="aspnet-signalr-releases-on-the-cdn"></a><span data-ttu-id="c8a1a-428">ASP.NET SignalR が CDN にリリースします。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-428">ASP.NET SignalR Releases on the CDN</span></span>

<span data-ttu-id="c8a1a-429">次の ASP.NET SignalR JavaScript ファイルは、この CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-429">The following ASP.NET SignalR JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-signalr-222"></a><span data-ttu-id="c8a1a-430">ASP.NET SignalR 2.2.2</span><span class="sxs-lookup"><span data-stu-id="c8a1a-430">ASP.NET SignalR 2.2.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.js

#### <a name="aspnet-signalr-221"></a><span data-ttu-id="c8a1a-431">ASP.NET SignalR 2.2.1</span><span class="sxs-lookup"><span data-stu-id="c8a1a-431">ASP.NET SignalR 2.2.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.js

#### <a name="aspnet-signalr-220"></a><span data-ttu-id="c8a1a-432">ASP.NET SignalR 2.2.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-432">ASP.NET SignalR 2.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.js

#### <a name="aspnet-signalr-210"></a><span data-ttu-id="c8a1a-433">ASP.NET SignalR 2.1.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-433">ASP.NET SignalR 2.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.js

#### <a name="aspnet-signalr-203"></a><span data-ttu-id="c8a1a-434">ASP.NET SignalR 2.0.3</span><span class="sxs-lookup"><span data-stu-id="c8a1a-434">ASP.NET SignalR 2.0.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.js

#### <a name="aspnet-signalr-202"></a><span data-ttu-id="c8a1a-435">ASP.NET SignalR 2.0.2</span><span class="sxs-lookup"><span data-stu-id="c8a1a-435">ASP.NET SignalR 2.0.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.js

#### <a name="aspnet-signalr-201"></a><span data-ttu-id="c8a1a-436">ASP.NET SignalR 2.0.1</span><span class="sxs-lookup"><span data-stu-id="c8a1a-436">ASP.NET SignalR 2.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.js

#### <a name="aspnet-signalr-200"></a><span data-ttu-id="c8a1a-437">ASP.NET SignalR 2.0.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-437">ASP.NET SignalR 2.0.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.js

#### <a name="aspnet-signalr-113"></a><span data-ttu-id="c8a1a-438">ASP.NET SignalR 1.1.3</span><span class="sxs-lookup"><span data-stu-id="c8a1a-438">ASP.NET SignalR 1.1.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.js

#### <a name="aspnet-signalr-112"></a><span data-ttu-id="c8a1a-439">ASP.NET SignalR 1.1.2</span><span class="sxs-lookup"><span data-stu-id="c8a1a-439">ASP.NET SignalR 1.1.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.js

#### <a name="aspnet-signalr-111"></a><span data-ttu-id="c8a1a-440">ASP.NET SignalR 1.1.1</span><span class="sxs-lookup"><span data-stu-id="c8a1a-440">ASP.NET SignalR 1.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.js

#### <a name="aspnet-signalr-110"></a><span data-ttu-id="c8a1a-441">ASP.NET SignalR 1.1.0</span><span class="sxs-lookup"><span data-stu-id="c8a1a-441">ASP.NET SignalR 1.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.js

#### <a name="aspnet-signalr-101"></a><span data-ttu-id="c8a1a-442">ASP.NET SignalR 1.0.1</span><span class="sxs-lookup"><span data-stu-id="c8a1a-442">ASP.NET SignalR 1.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.js

<span data-ttu-id="c8a1a-443">CDN の使用条件については、次を参照してください。 [Microsoft Ajax CDN の使用条件](https://www.asp.net/terms-of-use "Microsoft Ajax CDN の使用条件")します。</span><span class="sxs-lookup"><span data-stu-id="c8a1a-443">For information about the terms of use for the CDN, see [Microsoft Ajax CDN Terms of Use](https://www.asp.net/terms-of-use "Microsoft Ajax CDN Terms of Use").</span></span>
