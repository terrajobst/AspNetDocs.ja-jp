...
<div id="main" class="v2">
    <div class="container">
        <h1>ASP.NET のドキュメント</h1>
        <ul class="pivots">
            <li>
                <a href="#core">ASP.NET Core</a>
                <ul id="core">
                    <li>
                        <a href="#core_overview">概要</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET Core の概要</h3>
                                                    <p>5 分で任意のプラットフォームに最初の ASP.NET Core アプリを作成します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET Core の概要</h3>
                                                    <p>ASP.NET Core の新しい概念と、最新の Web アプリの開発にどのように役立つかを示します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>API リファレンス</h3>
                                                    <p>ASP.NET Core クラス ライブラリを探索します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET Core MVC の概要</h3>
                                                    <p>MVC 設計パターンを使用して Web アプリと API をビルドする方法を説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>無料のコース</h3>
                                                    <p>さまざまなトレーニング プロバイダーから無料で提供される ASP.NET Core を使用してアプリをビルドする方法を学習します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#core_tutorials">チュートリアル</a>
                        <ul id="core_tutorials" class="cardsZ">
                            <li>
                                <div class="container intro">
                                    <p>お勧めのチュートリアル | <a href="https://docs.microsoft.com/aspnet/core/tutorials/" data-raw-source="[View all ASP.NET Core tutorials](https://docs.microsoft.com/aspnet/core/tutorials/)">すべての ASP.NET Core チュートリアルの表示</a></p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mac で Web サイトをビルドする</h3>
                                                    <p>Visual Studio for Mac を使用して、Mac で最初の ASP.NET Core アプリをビルドします。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows で Visual Studio を使用して Web サイトをビルドする</h3>
                                                    <p>Visual Studio を使用して、最初の ASP.NET Core MVC アプリをビルドします。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web API をビルドする</h3>
                                                    <p>ASP.NET Core MVC と Visual Studio を使用して、最初の Web API をビルドします。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Entity Framework Core と ASP.NET Core の概要</h3>
                                                    <p>データ アクセスに Entity Framework Core を使用する ASP.NET Core MVC Web アプリケーションを作成します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Swagger を使用する ASP.NET Web API のヘルプ ページ</h3>
                                                    <p>Swagger と Swashbuckle を使用して、ASP.NET Web API のドキュメントとヘルプ ページを生成します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio を使用して Azure に ASP.NET Core Web アプリを配置する</h3>
                                                    <p>Azure App Service で Web アプリを作成し、ASP.NET Core Web アプリを配置します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                ...
                <ul id="aspnet">
                    <li>
                        <a href="#aspnet_overview">概要</a>
                        <ul id="aspnet_overview" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>ASP.NET は、Windows で .NET を使用してエンタープライズ クラスのサーバー ベース Web アプリケーションをビルドするために必要なすべてのサービスを提供する成熟した Web プラットフォームです。</p>
                                    <p><a href="https://docs.microsoft.com/aspnet/core/choose-aspnet-framework" data-raw-source="[Learn the benefits of both ASP.NET Core and ASP.NET](https://docs.microsoft.com/aspnet/core/choose-aspnet-framework)">ASP.NET Core と ASP.NET の両方の利点を確認</a>し、自分に適したものを選択します。</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio をダウンロードする</h3>
                                                    <p>Visual Studio は、Windows 版 ASP.NET 用の無料の IDE です。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET の概要</h3>
                                                    <p>Web アプリケーションと Web API をビルドする場合、およびリアルタイムの機能を追加する場合の ASP.NET のテクノロジを比較します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET API リファレンス</h3>
                                                    <p>ASP.NET クラス ライブラリを探索します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Websites</h3>
                                                    <p>ASP.NET MVC 5 と Visual Studio を使用して Web サイトをビルドする方法を説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web API</h3>
                                                    <p>ASP.NET Web API 2 と Visual Studio を使用して Web API をビルドする方法を説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>リアルタイム</h3>
                                                    <p>ASP.NET SignalR 2 と Visual Studio を使用してチャット アプリケーションをビルドする方法を説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>無料のコース</h3>
                                                    <p>さまざまなトレーニング プロバイダーから無料で提供される ASP.NET を使用してアプリケーションをビルドする方法を学習します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li class="fullSpan">
                                <div class="container footer">
                                    <p><a href="https://github.com/aspnet/Docs/blob/master/CONTRIBUTING.md">ASP.NET ドキュメントやサンプルへの投稿</a></p>
                                </div>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#aspnet_framework">フレームワーク</a>
                        <ul id="aspnet_framework" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p><a href="/aspnet/overview#websites-and-web-applications">ASP.NET で Web サイトをビルドするためのさまざまなオプションを確認</a>し、自分に適したものを選択します。</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web フォーム</h3>
                                                    <p>使い慣れたドラッグ アンド ドロップのイベント ドリブン モデルを使用して、動的な Web サイトをビルドします。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MVC</h3>
                                                    <p>問題を完全に分離できる動的な Web サイトをビルドするための強力なパターン ベースの方法です。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web ページ</h3>
                                                    <p>動的な Web コンテンツを作成するために HTML を使用してサーバー コードを組み合わせるための高速でわかりやすい軽量な方法です。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web API</h3>
                                                    <p>ブラウザーやモバイル デバイスなど、さまざまなクライアントに提供される HTTP サービスを簡単にビルドできます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web フック</h3>
                                                    <p>簡単なパブリッシュ/サブスクライブ モデルを提供する軽量な HTTP パターンを使用して、Web API と SaaS サービスを接続します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SignalR</h3>
                                                    <p>アプリケーションにリアルタイムの Web 機能を追加します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#aspnet_tutorials">チュートリアル</a>
                        <ul id="aspnet_tutorials" class="cardsZ">
                            <li>
                                <div class="container intro">
                                    <p>お勧めのチュートリアル | <a href="https://docs.microsoft.com/aspnet/tutorials/" data-raw-source="[View all ASP.NET tutorials](https://docs.microsoft.com/aspnet/tutorials/)">すべての ASP.NET チュートリアルの表示</a></p>
                                </div>
                            </li>
                            <li>
                                <a href="https://docs.microsoft.com/aspnet/mvc/overview/getting-started/introduction/getting-started">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET MVC 5 の概要</h3>
                                                    <p>このチュートリアル シリーズでは、Visual Studio を使用した ASP.NET MVC 5 Web アプリのビルドの基礎について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET Web API 2 の概要</h3>
                                                    <p>このチュートリアルでは、ASP.NET Web API 2 と Visual Studio を使用した Web アプリのビルドの基礎について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SignalR 2 の概要</h3>
                                                    <p>このチュートリアルでは、SignalR を使用してリアルタイムのチャット アプリケーションを作成する方法を示します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MVC 5 を使用する Entity Framework 6 Code First の概要</h3>
                                                    <p>ASP.NET MVC 5 アプリケーションでデータを表示して編集するための Entity Framework 6 の使用の基礎です。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows コンテナーへの ASP.NET MVC アプリケーションの移行</h3>
                                                    <p>既存の ASP.NET MVC アプリケーションを取得し、Windows Docker コンテナーで実行する方法について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
