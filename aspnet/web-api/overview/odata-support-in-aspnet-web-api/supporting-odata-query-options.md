...
| 文字列関数。すべての製品"zz"の名前を返します。 | `http://localhost/Products?$filter=substringof('zz',Name)` |
| 日付関数:2005 より後に、すべての製品の ReleaseDate を返します。 | `http://localhost/Products?$filter=year(ReleaseDate)` gt 2005 |
