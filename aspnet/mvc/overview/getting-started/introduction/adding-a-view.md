...
ように見えますね。 ただし、ブラウザーのタイトル バーの表示"インデックス-My ASP.NET Application、"をページの上部にあるビッグ リンクという「アプリケーション名」に注意してください。 によってどのようにブラウザー ウィンドウを作成、表示する右上にある 3 本の棒をクリックする必要がありますに、**ホーム**、**について**、**連絡先**、 **登録**と**ログイン**リンク。
