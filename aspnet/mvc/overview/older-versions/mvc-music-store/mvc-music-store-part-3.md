...
## <a name="adding-a-view-template"></a><span data-ttu-id="b8b45-114">ビュー テンプレートを追加します。</span><span class="sxs-lookup"><span data-stu-id="b8b45-114">Adding a View template</span></span>
