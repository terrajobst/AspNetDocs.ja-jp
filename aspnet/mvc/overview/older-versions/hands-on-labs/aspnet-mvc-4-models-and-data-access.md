...
1. [手順 1:データベースを追加します。](#Exercise1)
2. [手順 2:Code First を使用してデータベースを作成します。](#Exercise2)
3. [手順 3:パラメーターを持つデータベースのクエリを実行します。](#Exercise3)
...
2. **Entity Data Model ウィザード**が表示されます。 このウィザードでモデル レイヤーの作成手順を説明します。 最近追加された既存のデータベースに基づいてモデルを作成する必要があります、ために選択**データベースから生成** をクリック**次**します。
...
このタスクで Code First を使用して最初に作成されたとき、データベースにサンプル データを読み込みます。
...
### <a name="exercise-3-querying-the-database-with-parameters"></a>手順 3:パラメーターを持つデータベースのクエリを実行します。
