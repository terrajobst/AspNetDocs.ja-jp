...
<span data-ttu-id="b0d03-188">内で右クリックし、`Welcome`メソッドとクリック**ビューの追加**します。</span><span class="sxs-lookup"><span data-stu-id="b0d03-188">Then right-click inside the `Welcome` method and click **Add View**.</span></span>
