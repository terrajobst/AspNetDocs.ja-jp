...
title: MVC を使用したはじめに |Microsoft Docs
author: rick-anderson
description: これは、ASP.NET MVC を紹介する初心者向けチュートリアルシリーズです。 データベースを読み書きする単純な web アプリケーションを作成します。
ms.author: riande
ms.date: 11/08/2011
...
ms.locfileid: "78437176"
---
# <a name="getting-started-with-mvc"></a>MVC の概要

> これは、ASP.NET MVC を紹介する初心者向けチュートリアルシリーズです。 データベースを読み書きする単純な web アプリケーションを作成します。
