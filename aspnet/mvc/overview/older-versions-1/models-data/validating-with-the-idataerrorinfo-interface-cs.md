...
<span data-ttu-id="32b0f-151">リスト 2 で、クラスを Models フォルダーに追加します。</span><span class="sxs-lookup"><span data-stu-id="32b0f-151">Add the class in Listing 2 to the Models folder.</span></span>
