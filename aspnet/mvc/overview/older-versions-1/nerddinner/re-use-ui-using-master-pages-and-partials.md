...
### <a name="using-partial-view-templates"></a><span data-ttu-id="0a41c-124">部分ビュー テンプレートの使用</span><span class="sxs-lookup"><span data-stu-id="0a41c-124">Using Partial View Templates</span></span>
