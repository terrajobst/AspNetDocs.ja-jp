...
<span data-ttu-id="eebd8-124">そのためにできる 2 つの方法を見てみましょう。</span><span class="sxs-lookup"><span data-stu-id="eebd8-124">Let's look at two ways we can accomplish this.</span></span>
