...
title: 'イテレーション #7 – Ajax 機能の追加 (VB) |Microsoft Docs'
author: microsoft
...
ms.locfileid: "78487000"
---
# <a name="iteration-7--add-ajax-functionality-vb"></a>イテレーション #7 – Ajax 機能の追加 (VB)

[Microsoft](https://github.com/microsoft)

[コードのダウンロード](iteration-7-add-ajax-functionality-vb/_static/contactmanager_7_vb1.zip)
...
[連絡先のみを更新 ![](iteration-7-add-ajax-functionality-vb/_static/image1.jpg)](iteration-7-add-ajax-functionality-vb/_static/image1.png)

**図 01**: 連絡先のみを更新[する (クリックすると、フルサイズの画像が表示](iteration-7-add-ajax-functionality-vb/_static/image2.png)される)
...
**図 02**: 削除の確認ページ ([クリックすると、フルサイズの画像が表示](iteration-7-add-ajax-functionality-vb/_static/image4.png)されます)
...
> [[戻る]](iteration-6-use-test-driven-development-vb.md)
