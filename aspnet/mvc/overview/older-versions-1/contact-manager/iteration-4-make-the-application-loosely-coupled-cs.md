...
title: 'イテレーション #4 –アプリケーションを疎結合する (C#) |Microsoft Docs'
author: microsoft
...
ms.locfileid: "78437974"
---
# <a name="iteration-4--make-the-application-loosely-coupled-c"></a>イテレーション #4 –アプリケーションを疎結合にするC#()

[Microsoft](https://github.com/microsoft)

[コードのダウンロード](iteration-4-make-the-application-loosely-coupled-cs/_static/contactmanager_4_cs1.zip)
...
**リスト 4-Model\ contactmanagerservice, cs**
...
**リスト 8-モデル \ 検証 \ ivalidationdictionary, cs**
