...
---
<a name="aspnet-mvc-storefront-part-8-testing-controllers-iteration-1-complete"></a>ASP.NET MVC Storefront 第 8 部:コントローラーのテスト、繰り返し 1 完了
====================
によって[Rob Conery](https://github.com/robconery)

Rob は、コント ローラーのテストでの作業も、サイトの初期のイテレーションを終了します。

[&#9654;ビデオ (30 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-mvc-storefront-part-8-testing-controllers-iteration-1-complete)
