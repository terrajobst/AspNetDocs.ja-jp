...
> このセクションのビデオでは、ASP.NET MVC について説明します。これには、最初から最後まで、電子商取引アプリケーション全体をビルドする方法も含まれます。
...
- [ASP.NET MVC ビューのデータを管理するためのビューモデルを実装する](how-do-i-implement-view-models-to-manage-data-for-aspnet-mvc-views.md)
